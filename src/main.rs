...
fn main() {
    ...
    let mut particle1 = Particle {
        ...
        acceleration: Vector2::new(0.0, gravity),
        color: Color::BLUE,
        charge: -10.0,
        mass: 1.0
    };
    ...
    while !rl.window_should_close() {
        ...
        //G acceleration??
        particle1.velocity.y -= particle1.acceleration.y;
        particle2.velocity.y -= particle2.acceleration.y;

        //Electric acceleration
        particle1.velocity.x -= particle1.acceleration.x;
        particle2.velocity.x += particle2.acceleration.x;
